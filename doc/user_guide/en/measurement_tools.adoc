...
`refspec.dat` will appear in your log directory and the *Ref Spec*
checkbox on the *Wide Graph* will become available.  When you check
*Ref Spec*, the recorded reference spectrum will then be used to
flatten your overall effective passband.
