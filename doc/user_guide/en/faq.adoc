...
Update to the latest Windows installer package or reinstall _WSJT-X_.
Current Windows installers include the required _OpenSSL_ runtime DLLs;
see <<OPENSSL,Windows _OpenSSL_ troubleshooting>>.
