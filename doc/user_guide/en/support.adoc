...
The best source of help in setting up your station or configuring or
using _WSJT-X_ will be one of these email lists: {wsjtx_group},
{wsjt_group}, or {wsjt-devel}. The chances are good that someone with
similar interests and equipment has already solved your problem and
will be happy to help.  To post messages in any of these forums you
will need to join the group.
...
it to us at the public {devrepo} site or one of the email addresses
given above.  Be sure to explain why you think the feature is
desirable, and what sort of other users might find it so. 
