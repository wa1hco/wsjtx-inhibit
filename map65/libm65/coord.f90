...
subroutine coord(A0, B0, AP, BP, A1, B1, A2, B2)
  ...
  !--------------------------------------------------------------------
  real(real32), intent(in)  :: A0, B0, AP, BP
  real(real32), intent(in)  :: A1, B1
  real(real32), intent(out) :: A2, B2

  !--------------------------------------------------------------------
  ! Locals
  !--------------------------------------------------------------------
  real(real64) :: SB0, CB0, SBP, CBP, SB1, CB1
  real(real64) :: SB2, CB2, SAA, CAA, CBB, SBB
  real(real64) :: SA2, CA2, TA2O2
